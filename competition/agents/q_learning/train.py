"""Train the Q-learning tabular agent for the competition.

Usage::

    python -m competition.agents.q_learning.train --n-episodes 3000

O servidor Java precisa estar rodando na porta 4242 antes de iniciar
(ver ``CLAUDE.md``). Hiperparâmetros default seguem
``competition/agents/q_learning/02-modelagem.md``.
"""
...
_DEFAULT_SAVE_PATH = Path(__file__).with_name('ql_agent.pkl')
...
def train(
    ...
    """Treina o QLearningAgent e salva a Q-table em ``save-path``."""
